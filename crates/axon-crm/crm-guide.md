...
- Connections are pooled up to **3 concurrent connections** (WAL serializes writers anyway; the small pool keeps memory down on 1 GB hosts), each with a 10 s busy timeout and a 1 MB page cache.
