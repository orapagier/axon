...
impl GoogleService {
    ...
    pub fn tool_list() -> Vec<Tool> {
        let mut tools = vec![
            ...
            Tool { name: "gcal_get_freebusy".into(), description: "Check free/busy time for a list of calendars.".into(),                          input_schema: schema!({"calendar_ids":{"type":"array","items":{"type":"string"}},"time_min":{"type":"string","description":"Window start; any common datetime format or Unix timestamp"},"time_max":{"type":"string","description":"Window end; same flexible formats as time_min"}}, ["calendar_ids","time_min","time_max"]) },
